...
from app.controllers import test_controller, node_position_controller, analytics_controller
...
api_router.include_router(analytics_controller.router, tags=["analytics"]) 